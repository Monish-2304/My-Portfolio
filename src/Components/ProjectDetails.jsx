    ...
    <div className="fixed inset-0 my-8 flex items-center justify-center  z-50 ">
      <div className="w-full my-20 max-w-md md:max-w-screen-md bg-[#171721] opacity-100 rounded-3xl flex flex-col max-h-full">
        ...
        <div className="flex flex-col w-full px-4 pr-5 overflow-y-auto">
          ...
          />
          <h2 className="text-3xl text-gray-200 font-bold mb-2">
          ...
          <p className="text-lg text-justify text-gray-200 mb-4 whitespace-pre-line">
          ...
          <div className="flex w-full justify-center">
            {selectedProject.github && (
              <a
                ...
                className="bg-[#1c1e27] hover:bg-purple-800 transition-all duration-300 w-full sm:w-1/2 text-center text-white px-4 py-2 rounded-lg mb-4 m-1"
              >
                View on Github
              </a>
            )}
            {selectedProject.webapp && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-purple-800 hover:bg-[#1c1e27] transition-all duration-300 w-full sm:w-1/2 text-center text-white px-4 py-2 rounded-lg mb-4 m-1"
              >
                View Demo
              </a>
            )}
